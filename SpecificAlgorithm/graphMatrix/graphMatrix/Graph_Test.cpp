...
void randomGraph ( struct GraphMatrix<Tv, Te> & g, int n, int e ) { //assert: 0 < e(e-1) <= v
 ...
 * 从命令行（文件重定向）中导入图
 ******************************************************************************************/
void importGraph ( struct GraphMatrix<char, int> & g ) {
   int n;
...
int main ( int argc, char* argv[] ) {
   ...
   //srand( 7654321 );
    structGraph<char, int>* g = (structGraph<char, int> *) malloc(sizeof structGraph<char, int>);
